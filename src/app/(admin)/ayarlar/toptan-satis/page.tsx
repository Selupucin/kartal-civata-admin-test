...
export default function WholesaleSettingsPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success('Toptan satış ayarları kaydedildi');
    },
    onError: () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-slate-800">Toptan Satış Ayarları</h2>
          <p className="mt-1 text-sm text-slate-400">Toptan satış minimum sipariş adedi ve indirim oranı</p>
        </div>
        <Button
            ...
            <div className="flex items-center justify-between text-xs text-slate-400">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-24 rounded-lg border border-slate-200 px-3 py-1.5 text-center text-sm font-semibold text-slate-700 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                />
